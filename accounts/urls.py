...
from .views import (
    ...
    RestorePasswordView, RestorePasswordDoneView, RestorePasswordConfirmView,redirect_login_url
)
...
urlpatterns = [
    ...
    path('redirect-to-login/',redirect_login_url,name='redirect_login_url'),
]
