...
class SignIn(UserCacheMixin, forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if settings.USE_REMEMBER_ME:
            ...
            self.fields['remember_me'] = forms.BooleanField(label=_(''), required=False)
...
class SignInViaEmailForm(SignIn):
    ...
    def clean_email(self):
        ...
        if not user:
            raise ValidationError(_('You entered an invalid Email.'))
...
class SignUpForm(UserCreationForm):
    ...
    email = forms.EmailField(
        ...
        widget=forms.EmailInput(attrs={'id':'id_email_form'}))
...
class RestorePasswordViaEmailOrUsernameForm(UserCacheMixin, forms.Form):
    email_or_username = forms.CharField(label=_('Email or Username'),widget=forms.TextInput(attrs={'id':'id_email_or_username_r_p'}))
...
class ChangeEmailForm(forms.Form):
    ...
    def clean_email(self):
        ...
        if user:
            raise ValidationError(_('You can not use this email.'))
